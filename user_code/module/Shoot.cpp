...
//射速等级  摩擦电机
fp32 shoot_fric_grade[4] = {0, 15 * fric_refree_para, 20 * fric_refree_para, 25 * fric_refree_para};
...
void Shoot::feedback_update()
{
    ...
    shoot_fric_grade[2] = 20 * fric_refree_para;
    shoot_fric_grade[3] = 25 * fric_refree_para;
